...
public class FlightsPage extends BasePage {
    ...
    public void selectInLapOrSeat(String s) {
        ...
        if (s.equalsIgnoreCase("lap")) {
            radioButton = pd.getWebDriverWait(2)
                    .until(ExpectedConditions.elementToBeClickable(pd.findPageElement("id_ChildrenInLap_RadioButton")));
        } else {
            radioButton = pd.getWebDriverWait(2)
                    .until(ExpectedConditions.elementToBeClickable(pd.findPageElement("id_ChildrenInSeat_RadioButton")));
        }
    ...
    public void clickSearchButton() {
        pd.findPageElement("xpath_searchButton").click();
    }
